...
$(document).ready(function() {
	$(".add-members").click(function () {
		$('.demo.sidebar.members-sidebar').sidebar('toggle');
	});
	$(".message").click(function () {
		$('.demo.sidebar.messages-sidebar').sidebar('toggle');
	});
	$(".new-component").click(function () {
		$('.demo.sidebar.component-sidebar').sidebar('toggle');
	});
	// $("body").click(function() {
	...
	$(".sidebar-button").hover(function () {
		...
		$(this).find(".sidebar-text").slideToggle("fast");

		// slide("right", "fast", function() {
		// 	$(this).toggle("fast");
		// });
	});
});
